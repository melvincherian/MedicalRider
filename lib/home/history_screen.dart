...
// /// Delivery Charge added logic in front end///
...
//                           // ✅ FIXED: Show actual delivery charge from order field
//                           Container(
//                             padding: const EdgeInsets.symmetric(
//                               horizontal: 12,
//                               vertical: 4,
...
//               // ✅ FIXED: Pass order.deliveryCharge to billing details widget
//               if (order.billingDetails != null)
...
//     HistoryProvider provider,
//   ) {
//     // ✅ FIXED: Use actual values from order fields directly
//     final double subTotal = order.totalAmount - order.platformCharge - order.deliveryCharge;
//     final double totalPaid = order.totalAmount;
...
//         ),
//         const SizedBox(height: 4),
//         // ✅ FIXED: Use real delivery charge
//         Row(
//           mainAxisAlignment: MainAxisAlignment.spaceBetween,
//           children: [
//             const Text(
...
//   // ✅ FIXED: Added rawDeliveryCharge parameter to override incorrect billingDetails value
//   Widget _buildBillingDetails(
//     BillingDetailsModel billing,
//     HistoryProvider provider,
//     double rawDeliveryCharge,
//   ) {
//     // Parse subTotal and platformFee from billing strings (e.g. "₹235.00" → 235.0)
//     final double subTotalValue = double.tryParse(
//           billing.subTotal.replaceAll('₹', '').replaceAll(',', ''),
//         ) ??
//         0.0;
//     final double platformFeeValue = double.tryParse(
//           billing.platformFee.replaceAll('₹', '').replaceAll(',', ''),
//         ) ??
//         0.0;

//     // ✅ Recalculate correct total using real delivery charge
//     final double correctTotal =
//         subTotalValue + platformFeeValue + rawDeliveryCharge;
...
//         ),
//         const SizedBox(height: 4),
//         // ✅ FIXED: Use rawDeliveryCharge instead of billing.deliveryCharge
//         Row(
//           mainAxisAlignment: MainAxisAlignment.spaceBetween,
//           children: [
//             const Text(
...
//             ),
//             Text(
//               '₹${rawDeliveryCharge.toStringAsFixed(2)}',
//               style: const TextStyle(fontSize: 12, color: Colors.black87),
//             ),
//           ],
//         ),
...
//         const Divider(height: 1),
//         const SizedBox(height: 4),
//         // ✅ FIXED: Show recalculated correct total
//         Row(
//           mainAxisAlignment: MainAxisAlignment.spaceBetween,
//           children: [
//             const Text(
...
//             ),
//             Text(
//               '₹${correctTotal.toStringAsFixed(2)}',
//               style: const TextStyle(
//                 fontSize: 14,
//                 fontWeight: FontWeight.w600,
//                 color: Colors.black,
